...
namespace NoteShare.Data.Migrations
{
    ...
    [Migration("20240303162449_Note_Comment")]
    partial class Note_Comment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NoteShare.Data.Entities.Note", b =>
                {
            ...
            modelBuilder.Entity("NoteShare.Data.Entities.NoteComment", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("NoteShare.Data.Entities.NoteFile", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("NoteShare.Data.Entities.Note", b =>
                {
                    b.HasOne("NoteShare.Data.Entities.User", "CreatedUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("NoteShare.Data.Entities.User", "LastModifiedUser")
                        .WithMany()
                        .HasForeignKey("ModifiedBy")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("NoteShare.Data.Entities.Student", null)
                        .WithMany("Notes")
                    ...
                    b.HasOne("NoteShare.Data.Entities.Teacher", null)
                        .WithMany("Notes")
            ...
            modelBuilder.Entity("NoteShare.Data.Entities.NoteComment", b =>
                {
                    ...
                    b.HasOne("NoteShare.Data.Entities.Note", "Note")
                        .WithMany("Comments")
